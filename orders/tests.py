...
class SeleniumInicioTestCase(StaticLiveServerTestCase):
    ...
    def test_contrareembolso_positive(self):
        ...
        self.driver.find_element(By.ID, "last_name").send_keys("Test2")
        self.driver.find_element(By.ID, "email").send_keys("correotest@gmail.com")
        self.driver.find_element(By.ID, "address").send_keys("test, 23, 8")
        self.driver.find_element(By.ID, "postal_code").send_keys("41008")
        self.driver.find_element(By.ID, "city").send_keys("Test")
        dropdown = Select(self.driver.find_element(By.ID, "tipo_pago"))
    ...
    def test_tarjeta_positive(self, tarj="4111 1111 1111 1111"):
        ...
        self.driver.find_element(By.ID, "accept_terms").click()
        self.driver.find_element(By.ID, "btn1").click()
